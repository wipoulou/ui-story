...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "django-insecure-+s^0jn5)2)jeig4f_09elnrm%t_h+a!0vn#*^tey(2u#prdw4f"
)
...
ALLOWED_HOSTS = (
    [h.strip() for h in _allowed_hosts.split(",") if h.strip()] if _allowed_hosts else []
)
...
# OIDC settings for GitLab (configure via environment variables)
